...
VER = "nmaster_0214"  # comment out wdt from nmaster_020e.py
...
def init_system():
    ...
    global mid, ch, debug_mode, config_data, sids, mqtt_client, esp, poller, sm
    ...
    try:
        ...
        # Load SID mapping
        msids_file = f"msids_{mid.lower()}.json"
        sids = read_json_file(msids_file)
    except Exception as err:
